...
const Loader = () => {
    return (
        <div className='bg-gray-100 mt-20 h-screen'>
            <div className=" rounded relative">
                <div className="rounded-full bg-teal-400 w-[190px] h-[190px] relative flex justify-center items-center mx-auto animate-spin">
